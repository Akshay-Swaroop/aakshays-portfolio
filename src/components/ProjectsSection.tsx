...
const projects = [
  {
    ...
    demo: "https://huggingface.co/spaces/akshayswaroop/facial-emotion-recognition",
  },
  {
    ...
    demo: "https://akshayswaroop-emotiontrack-sentimentanalysis.hf.space",
  },
  {
          ...
          {projects.map((proj) => (
            <div key={proj.title} className="glass-card p-6 group hover:-translate-y-1 transition-transform duration-300">
              ...
              <h3 className="font-heading font-semibold text-foreground mb-2 group-hover:text-primary transition-colors">
                {proj.demo ? (
                  <a href={proj.demo} target="_blank" rel="noopener noreferrer" className="hover:underline">
                    {proj.title}
                  </a>
                ) : (
                  proj.title
